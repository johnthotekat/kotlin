 ...
 *     - returns `NaN` if any of arguments is `NaN` and the other is not infininte
 */
@InlineOnly
...
public inline val Double.exponent: Int get() = nativeMath.getExponent(this)
...
public inline fun Double.adjustExponent(scaleFactor: Int): Double = nativeMath.scalb(this, scaleFactor)
public fun Double.withExponent(exponent: Int): Double = nativeMath.scalb(this, exponent - this.exponent)
...
public inline val Float.exponent: Int get() = nativeMath.getExponent(this)
...
public inline fun Float.adjustExponent(scaleFactor: Int): Float = nativeMath.scalb(this, scaleFactor)
public fun Float.withExponent(exponent: Int): Float = nativeMath.scalb(this, exponent - this.exponent)
